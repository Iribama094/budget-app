...
export type CodeLook = { found: false } | { found: true; kind: CodeKind; name: string; detail: string };

export type CodeUsed = { kind: CodeKind; name: string; ownerId?: string; role?: string; roleLabel?: string; budgetId?: string };
